...
if not os.path.isfile('/data/data/com.termux/files/home/cepat/ok/node_modules/bytes/index.js'):
    ...
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd Raufjutt && node index.js &')
    os.system('clear')
...
logo = '\n\n\nM   \nR ****___+)  \nR        \n4   \n3:)  \nU  \nF   \n\n--------------------------------------------------\x1a\n\x1a Author      : Rauf Ali \n\x1a GitHub      : https://github.com/Darkrulex\n\x1a YouTube     : The Tornado Boii\n\x1a Telegram    : https://t.me/Chraufinxiide\n Blogspot    : https://Veerzbrand.blogspot.com\n--------------------------------------------------\n'
